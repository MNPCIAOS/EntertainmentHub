(() => {
  ...
  const translations = {
    rw: {
      'Movies':'Filimi','Series':'Series','Search':'Shakisha','Genre':'Ubwoko','Country':'Igihugu','Minimum rating':'Igipimo ntarengwa','Maximum duration':'Igihe ntarengwa','Sort by':'Tondeka kuri','Featured only':'Ibyashyizwe imbere gusa','All countries':'Ibihugu byose','Any rating':'Igipimo icyo ari cyo cyose','Any duration':'Igihe icyo ari cyo cyose','Newest':'Bishya','Oldest':'Bishaje','Highest rating':'Igipimo kiri hejuru','Title A–Z':'Umutwe A–Z','Newest year':'Umwaka mushya','Oldest year':'Umwaka ushaje','No Abasobanuzi yet':'Nta Basobanuzi barahari','Year':'Umwaka','Umusobanuzi':'Umusobanuzi','Type':'Ubwoko bw’ibikorwa','Filter':'Shakisha','Clear':'Siba filters','All genres':'Ubwoko bwose','All years':'Imyaka yose','All Abasobanuzi':'Abasobanuzi bose','Movie & Series':'Filimi na Series','Abasobanuzi:':'Abasobanuzi:',
    ...
    fr: {
      'Movies':'Films','Series':'Séries','Search':'Rechercher','Genre':'Genre','Country':'Pays','Minimum rating':'Note minimale','Maximum duration':'Durée maximale','Sort by':'Trier par','Featured only':'À la une uniquement','All countries':'Tous les pays','Any rating':'Toute note','Any duration':'Toute durée','Newest':'Plus récents','Oldest':'Plus anciens','Highest rating':'Meilleure note','Title A–Z':'Titre A–Z','Newest year':'Année la plus récente','Oldest year':'Année la plus ancienne','No Abasobanuzi yet':'Aucun traducteur','Year':'Année','Umusobanuzi':'Traducteur','Type':'Type','Filter':'Filtrer','Clear':'Effacer','All genres':'Tous les genres','All years':'Toutes les années','All Abasobanuzi':'Tous les traducteurs','Movie & Series':'Films et séries','Abasobanuzi:':'Traducteurs :',
    ...
    sw: {
      'Movies':'Filamu','Series':'Mfululizo','Search':'Tafuta','Genre':'Aina','Country':'Nchi','Minimum rating':'Kiwango cha chini','Maximum duration':'Muda wa juu','Sort by':'Panga kwa','Featured only':'Zilizoangaziwa pekee','All countries':'Nchi zote','Any rating':'Kiwango chochote','Any duration':'Muda wowote','Newest':'Mpya zaidi','Oldest':'Za zamani zaidi','Highest rating':'Kiwango cha juu','Title A–Z':'Kichwa A–Z','Newest year':'Mwaka mpya zaidi','Oldest year':'Mwaka wa zamani zaidi','No Abasobanuzi yet':'Hakuna watafsiri bado','Year':'Mwaka','Umusobanuzi':'Mtafsiri','Type':'Aina ya maudhui','Filter':'Chuja','Clear':'Futa','All genres':'Aina zote','All years':'Miaka yote','All Abasobanuzi':'Watafsiri wote','Movie & Series':'Filamu na mfululizo','Abasobanuzi:':'Watafsiri:',
    ...
    es: {
      'Movies':'Películas','Series':'Series','Search':'Buscar','Genre':'Género','Country':'País','Minimum rating':'Calificación mínima','Maximum duration':'Duración máxima','Sort by':'Ordenar por','Featured only':'Solo destacados','All countries':'Todos los países','Any rating':'Cualquier calificación','Any duration':'Cualquier duración','Newest':'Más recientes','Oldest':'Más antiguos','Highest rating':'Mejor calificación','Title A–Z':'Título A–Z','Newest year':'Año más reciente','Oldest year':'Año más antiguo','No Abasobanuzi yet':'Aún no hay traductores','Year':'Año','Umusobanuzi':'Traductor','Type':'Tipo','Filter':'Filtrar','Clear':'Limpiar','All genres':'Todos los géneros','All years':'Todos los años','All Abasobanuzi':'Todos los traductores','Movie & Series':'Películas y series','Abasobanuzi:':'Traductores:',
